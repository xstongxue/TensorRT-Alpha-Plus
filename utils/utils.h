...
namespace utils 
{
    ...
    struct InitParameter
    {
        ...
        std::string winname = "TensorRT-Alpha-Plus";
        int char_width = 11; 
    ...
    enum class InputStream { IMAGE, VIDEO, CAMERA, MAT };
    ...
    // setInputStream 的重载版本
    bool setInputStream(const InputStream& source, const cv::Mat& img, const std::string& videoPath, const int& cameraID,
        cv::VideoCapture& capture, int& totalBatches, int& delayTime, InitParameter& param);
